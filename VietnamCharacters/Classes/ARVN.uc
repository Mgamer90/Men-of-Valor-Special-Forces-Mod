class ARVN extends Marine;

#exec obj load file="..\animations\modelhuman_marine_thin" package=ModelHuman_Marine_Thin
...
defaultproperties
{
     Head=Class'VietnamGame.USMC_Helmet_ARVN'
     Back=None
     LeftBackBelt=Class'VietnamGame.USMC_Canteen_LeftBack'
     RightFrontBelt=None
     BackBelt=Class'VietnamGame.USMC_ButtPack'
     Begin Object Class=AIFriendlyParams Name=AIFriendlyParams1
         Name="AIFriendlyParams1"
     End Object
     AI=AIFriendlyParams'VietnamCharacters.AIFriendlyParams1'
     ...
     AssetName="ModelHuman_ARVN_Thin.ARVN_Thin"
}

...
*/
class USMC_SturgesRadioMan extends USMC_RadioMan;

defaultproperties
{
     RadioManDialogPreCacheArray(0)=(PackageName="DialogOP3_snd",ResourceName="A_HOG_OP3_L1_14")
     Begin Object Class=AIFriendlyParams Name=AIFriendlyParams17
         Name="AIFriendlyParams17"
     End Object
     AI=AIFriendlyParams'VietnamCharacters.AIFriendlyParams17'

...
class WeaponFragGrenade extends WeaponBaseGrenade;
...
defaultproperties
{
     ...
     AmmoName=Class'VietnamWeapons.AmmoFragGrenade'
     ShakeMag=0.000000
     ShakeVert=(Z=0.000000)
     MeshName="USMC_Viewmodels.fps_frag"
     InventoryGroup=4
     PickupType="PickupFragGrenade"
     PlayerHorizSplitViewOffset=(X=16.950001,Y=2.850000,Z=-14.500000)
     PlayerVertSplitViewOffset=(X=16.950001,Y=2.850000,Z=-16.500000)
     AttachmentClass=Class'VietnamWeapons.WeaponFragGrenadeAttachment'

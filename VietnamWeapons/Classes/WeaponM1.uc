...
class WeaponM1 extends VietnamWeapon;
...
defaultproperties
{
     ...
     WeaponAnimationFrameCount(2)=88.000000
     WeaponAnimationFrameCount(3)=13.000000
     WeaponAnimationFrameCount(4)=10.000000
     ...
     MeshName="USMC_Viewmodels.fps_Thompson"
     InventoryGroup=12
     PickupType="PickupM1"
     ...
     ThirdPersonRelativeRotation=(Yaw=17000,Roll=-250)
     AttachmentClass=Class'VietnamWeapons.WeaponM1Attachment'
     ItemName="M1"
